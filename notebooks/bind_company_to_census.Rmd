...
tweak the census data
```{r}
censusdata <- censusdata %>% 
  mutate(
    location = case_when(
      location == 'Memphis, TN-MS-AR Metro Area' ~ 'Gr. Memphis Area',
      location == 'Nashville-Davidson--Murfreesboro--Franklin, TN Metro Area' ~ 'Gr. Nashville Area',
      TRUE ~ location
    )
  )
```
